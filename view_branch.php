    ...
    $sql = "DELETE FROM branch WHERE id = $id";
        if (mysqli_query($con, $sql)) {
            ...
            exit();
             ...
             echo '<script>alert("this branch used in another table so you can not delete it.")</script>';
        }
}

$sql_p = "SELECT * FROM `branch`";
                       ...
                       <div class="text-center mt-3">
                           <form method="GET" class="form-inline justify-content-center" id="srchfrm">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control" placeholder="Search by Branch" id="search">
                                </div>
                            </form>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody id="ans">
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                                     <a href="view_branch.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-primary">   DELETE</a>
                                            <a href="add_branch.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-danger">EDIT</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
