...
if(isset($_GET['id'])) {
    ...
    $sql = "DELETE FROM role WHERE id = $id";
        if (mysqli_query($con, $sql)) {
            ...
            echo '<script>alert("this role used in another table so you can not delete it.")</script>';
        }
}

// $sql_p = "SELECT * FROM `role`";
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody id="ans">
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                                     <a href="view_role.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-primary">   DELETE</a>
                                            <a href="add_role.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-danger">EDIT</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
