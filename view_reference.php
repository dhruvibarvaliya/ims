    ...
    $sql = "DELETE FROM reference WHERE id = $id";
        if (mysqli_query($con, $sql)) {
            ...
            exit();
             ...
             echo '<script>alert("this reference used in another table so you can not delete it.")</script>';
        }
    }

$sql_p = "SELECT * FROM `reference`";
...
$start = ($page - 1) * $limit;
    ...
    $sql_page = "SELECT * FROM reference LIMIT $start, $limit";
    $sql1 = "SELECT * FROM reference";
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody id="ans">
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                                     <a href="view_reference.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-primary">   DELETE</a>
                                            <a href="add_reference.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-danger">EDIT</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
